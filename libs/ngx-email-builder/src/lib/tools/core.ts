...
import { IP_EMAIL_BUILDER_BLOCKS, IP_EMAIL_BUILDER_BLOCKS_DATA } from "../private-tokens";
...
export function addNewIPEmailBuilderBlock(block: Type<AIPEmailBuilderBlock>, type: string, title: string): EnvironmentProviders {
